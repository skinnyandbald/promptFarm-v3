...
class AdvisorConfigService
{
    ...
    {
        return "Never provide advice without specific evidence from documented experience. Challenge vague requests by demanding measurable definitions. Reference proven case studies before offering frameworks.";
    }
