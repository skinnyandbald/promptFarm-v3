...
class ResearchAdvisorPositions extends Command
{
    ...
    public function handle()
    {
        ...
        if ($all) {
            ...
            $advisorsToResearch = \App\Models\Advisor::pluck('key')->unique()->toArray();
        ...
        foreach ($advisorsToResearch as $advisorKey) {
            ...
            $existing = AdvisorPosition::where('advisor_key', $advisorKey)->first();
            ...
            if ($sync) {
                ...
                // Show the results
                $result = AdvisorPosition::where('advisor_key', $advisorKey)->first();
                if ($result) {
